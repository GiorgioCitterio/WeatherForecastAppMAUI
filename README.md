...
![GitHub file size in bytes on a specified ref (branch/commit/tag)](https://img.shields.io/github/size/GiorgioCitterio/WeatherForecastAppMAUI/https://github.com/GiorgioCitterio/WeatherForecastAppMAUI/releases/tag/1.0/)
